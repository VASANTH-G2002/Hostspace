...
const isRequired = value => value === '' ? false : true; //check is empty
const isBetween = (length, min, max) => length < min || length > max ? false : true; //check length in between
...
// validate form while typing completed
